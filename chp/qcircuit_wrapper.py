...
class Quantum_Operation(object):
    ...
    def run_one_circ(self, circuit): 
        ...
        circ_chp = chper.Chper(circ=circuit,
                               ...
                               anc_stabs=[],
                               anc_destabs=[],
                               input_output_files = True) #self.CHP_IO_files
...
class Measure_2_logicals(Quantum_Operation):
    ...
    def run_all(self, stab_kind):
        ...
        if len(self.circuits) == 2:
            ...
            only_M = list(self.run_one_circ(1).values())[0][0]
    
            return only_M, 'normal'

        elif len(self.circuits) == 1:
            
            return list(self.run_one_circ(0).values())[0][0], 'normal'



        # (1) Measure M first time
        first_M = list(self.run_one_circ(0).values())[0][0]
        ...
        second_M = list(self.run_one_circ(2).values())[0][0]
        ...
        if data_errors1.count('I') == 7:
            if first_M == second_M:
                ...
                third_M = list(self.run_one_circ(4).values())[0][0]
    ...
    def run_all_long(self, stab_kind):
        ...
        low_w += [list(self.run_one_circ(first_subcirc_i).values())[0][0]]
        #print 'low_w1 =', low_w[0]
        
        # (3) Measure high-weight operator first time
        high_w += [list(self.run_one_circ(first_subcirc_i+1).values())[0][0]]
        ...
        low_w += [list(self.run_one_circ(first_subcirc_i+4).values())[0][0]]
        #print 'low_w2 =', low_w[1]
        
        # (7) Measure high-weight operator second time
        high_w += [list(self.run_one_circ(first_subcirc_i+5).values())[0][0]]
        ...
        if low_w[0] != low_w[1]:
            low_w += [list(self.run_one_circ(first_subcirc_i+8).values())[0][0]]
            #print 'low_w3 =', low_w[2]
        if high_w[0] != high_w[1]:
            high_w += [list(self.run_one_circ(first_subcirc_i+9).values())[0][0]]
    ...
    def run_boundary_oper_flags_short_ion(self, error_det=False):
        ...
        low_w += [(list(self.run_one_circ(first_subcirc_i).values())[0][0]+1)%2]
        ...
        if error_det:
            ...
            high_w += [list(self.run_one_circ(first_subcirc_i+4).values())[0][0]]
        ...
        # We need to flip the outcome because there are 2 MS gates
        low_w += [(list(self.run_one_circ(first_subcirc_i+1).values())[0][0]+1)%2]
        ...
        if low_w[0]==low_w[1]:
            ...
            high_w += [list(self.run_one_circ(first_subcirc_i+6).values())[0][0]]
            ...
            if high_w[0]==high_w[1]:
                ...
                if corr_targ=='normal' and corr_anc=='normal':
                    ...
                    if (clause_targ or clause_anc) and clause_flag:
                        ...
                        low_w_3rd = list(self.run_one_circ(first_subcirc_i+11).values())[0][0]
                    ...
                    # else re-measure only X4
                        ...
                        high_w += [list(self.run_one_circ(first_subcirc_i+12).values())[0][0]]
            ...
            # If X4 (Z4) changed, then re-measure X4 (Z4).
                ...
                error_det_total = True
                corr_targ, corr_anc = 'normal', 'normal'
                high_w += [list(self.run_one_circ(first_subcirc_i+8).values())[0][0]]
        ...
        # If X2 (Z2) changed, measure X2 (Z2) a third time and measure X4 (Z4) one time only 
            ...
            error_det_total = True
            corr_targ, corr_anc = 'normal', 'normal'
            low_w += [(list(self.run_one_circ(first_subcirc_i+3).values())[0][0]+1)%2]
    ...
    def run_boundary_oper_flags_short(self, error_det=False):
        ...
        low_w += [list(self.run_one_circ(first_subcirc_i+2).values())[0][0]]
        ...
        if low_w[0]==low_w[1]:
            ...
            # (4) Measure the high-weight operator twice
            high_w += [list(self.run_one_circ(first_subcirc_i+1).values())[0][0]]
            high_w += [list(self.run_one_circ(first_subcirc_i+3).values())[0][0]]
            ...
            if high_w[0]==high_w[1]:
                ...
                if corr_targ=='normal' and corr_anc=='normal':
                    ...
                    if (clause_targ or clause_anc) and clause_flag:
                        # (7) Measure low-weight operator third time
                        low_w += [list(self.run_one_circ(first_subcirc_i+6).values())[0][0]]
                        if low_w[2]!=low_w[1]:
                            corr_targ, corr_anc = 'normal', 'normal'
                            # the correct eigenvalue of low_w was the first one.
                            low_w[2] = low_w[0]
                    ...
                    # else re-measure only X4
                        ...
                        # (8) Measure high-weight operator third time
                        high_w += [list(self.run_one_circ(first_subcirc_i+7).values())[0][0]]
...
class QEC_d3(Quantum_Operation):
    ...
    def run_one_bare_anc(self, circuit, code, stab_kind):
        ...
        #print("outcome: ", stabilizer_outcomes, data_errors)

        return data_errors, stabilizer_outcomes

    
    
    def run_one_bare_anc_new(self, circuit, code=0, stab_kind=0, errors_det=0,
    ...
    def run_fullQEC_CSS_perfect(self, code):
        ...
        Z_data_errors, X_data_errors = [], []
        X_stab_outcomes, Z_stab_outcomes = [], []
        #print(Z_data_errors, X_data_errors)
...
class Verify_CatState(Quantum_Operation):
    ...
    def create_and_verify_8cat_state(self):
        ...
        for ver_i in range(len(self.circuits)):
            ...
            outcomes = [outcome[0] for outcome in list(output_dict.values())]
...
class QEC_d5(QEC_d3):
    ...
    def measure_octagon(self, weight8_gate):
        ...
        couple_circ.to_ancilla(list(range(17,17+8)))
        ...
        oct_parity = sum([outcome[0] for outcome in list(oct_dict.values())])%2
...
class QEC_with_flags(Quantum_Operation):
    ...
    def run_one_type_stabilizers_high_indet_d5(self, index_first_subcirc,
        ...
        if errors_det >= 2:
            ...
            for i in range(8):
                ...
                syndromes += [list(out_dict.values())[0][0]]
    ...
    def run_stabilizers_high_indet_ion(self, index_first_subcirc, alternating=True,
        ...
        if decoder == 'new':
            ...
            if len(subcircs_indices) < 3:
                ...
                case = 1
                next_subcircs = list(range(9,18))
            elif len(subcircs_indices) < 6:
                subcircs_run = len(subcircs_indices) - 1
                next_subcircs = list(range(12,18)) + [9,10]
                case = 2
    ...
    def run_QEC_FT_lattsurg_ion(self, stab='all'):
        ...
        if stab==2:
            syn3 = list(self.run_one_circ(7).values())[0][0]
            subcircs_run += [7] 
            ...
            syn2 = list(self.run_one_circ(6).values())[0][0]
            subcircs_run += [6] 
        ...
        output_first = list(self.run_one_circ(0).values())
        subcircs_run += [0] 
        ...
        if syn1==1 or flag1==1:
            ...
            output_second = list(self.run_one_circ(1).values())
            subcircs_run += [1] 
            ...
            if flag2==1:
                ...
                if syn2==1:
                    ...
                    self.run_one_circ(3)
                    subcircs_run += [3] 
                    syn1 = list(self.run_one_circ(5).values())[0][0]
                    subcircs_run += [5] 
                ...
                # if no error was detected, measure the third stabilizer FT
                    ...
                    output_third = list(self.run_one_circ(2).values())
                    subcircs_run += [2] 
    ...
    def run_QEC_FT_lattsurg(self, stab='all'):
        ...
        if stab==2:
            syn3 = list(self.run_one_circ(5).values())[0][0]
            return [0,0,syn3], [0,0,0], corr_type, error_det
            
        elif stab==1:
            syn2 = list(self.run_one_circ(4).values())[0][0]
        ...
        if syn1==1 or flag1==1:
            ...
            if flag2==1:
                ...
                if syn2==1:
                    ...
                    syn1 = list(self.run_one_circ(3).values())[0][0]
                    #print 'syn1 (second time) =', syn1
    ...
    def run_QECX_nonFT(self, previous_syn):
        ...
        syn2 = list(self.run_one_circ(0).values())[0][0]
        ...
        if syn2 != previous_syn[1]:
            ...
            syn3 = list(self.run_one_circ(1).values())[0][0]
    ...
    def run_jointQECZ(self, error_det, inflags1, inflags2):
        ...
        if error_det:
            ...
            syn1 = []
            for i in range(3,6):
                syn1 += [list(self.run_one_circ(i).values())[0][0]]
            
            # Second logical qubit
            syn2 = []
            for i in range(12,15):
                syn2 += [list(self.run_one_circ(i).values())[0][0]]
            ...
            error_det1 = False
            syn1 = []
            out_run1 = list(self.run_one_circ(1).values())
            syn1 += [out_run1[0][0]]
            ...
            error_det2 = False
            syn2 = []
            out_run2 = list(self.run_one_circ(10).values())
            syn2 += [out_run2[0][0]]
            ...
            # the other 2 stabilizer pairs with no flags.
                ...
                syn2 += [list(self.run_one_circ(12).values())[0][0]]
                ...
                if (1 in syn1) and (1 in syn2):
                    ...
                    syn1 += [list(self.run_one_circ(5).values())[0][0]]
                    syn2 += [list(self.run_one_circ(14).values())[0][0]]
            ...
            if outflags1==1:
                syn_flags1 = []
                syn_flags1 += [list(self.run_one_circ(7).values())[0][0]]
                syn_flags1 += [list(self.run_one_circ(8).values())[0][0]]
            ...
            if outflags2==1:
                syn_flags2 = []
                syn_flags2 += [list(self.run_one_circ(16).values())[0][0]]
                syn_flags2 += [list(self.run_one_circ(17).values())[0][0]]
                if sum(syn_flags2) > 0:
                    if syn_flags2[0] == 0:
                        total_corr2[1] = 'Z'
                        total_corr2[2] = 'Z'
            ...
            for i in range(first_elem,first_elem+3):
                out_run = list(self.run_one_circ(i).values())
                syn1 += [out_run[0][0]]
    ...
    def run_jointQECZ_ion(self, error_det, inflags1, inflags2):
        ...
        if error_det:
            ...
            error_det2 = False
            syn2 = []
            out_run2 = list(self.run_one_circ(n_subcirc+1).values())
            ...
            # First we measure the other boundary stabilizer
                ...
                syn2 += [list(self.run_one_circ(n_subcirc+5).values())[0][0]]
                ...
                if (1 in syn1) and (1 in syn2):
                    ...
                    syn1 += [list(self.run_one_circ(7).values())[0][0]]
                    subcircs_run_QECnonanc[7] = 1
                    syn2 += [list(self.run_one_circ(n_subcirc+7).values())[0][0]]
            ...
            if outflags1==1:
                syn_flags1 = []
                syn_flags1 += [list(self.run_one_circ(10).values())[0][0]]
                subcircs_run_QECnonanc[10] = 1
                syn_flags1 += [list(self.run_one_circ(11).values())[0][0]]
            ...
            if outflags2==1:
                syn_flags2 = []
                syn_flags2 += [list(self.run_one_circ(n_subcirc+10).values())[0][0]]
                subcircs_run_QECanc[10] = 1
                syn_flags2 += [list(self.run_one_circ(n_subcirc+11).values())[0][0]]
    ...
    def run_jointQECX(self, error_det, inflags1, inflags2):
        ...
        if error_det:
            ...
            error_det1 = False
            syn1 = []
            out_run1 = list(self.run_one_circ(0).values())
            syn1 += [out_run1[0][0]]
            outflags1 = out_run1[1][0]
            if outflags1==1:  error_det1 = True
            ...
            error_det2 = False
            syn2 = []
            out_run2 = list(self.run_one_circ(9).values())
            syn2 += [out_run2[0][0]]
            outflags2 = out_run2[1][0]
            if outflags2==1:  error_det2 = True
            ...
            # the other 2 stabilizer pairs with no flags.
                ...
                if (1 in syn1) and (1 in syn2):
                    ...
                    syn1 += [list(self.run_one_circ(4).values())[0][0]]
                    syn2 += [list(self.run_one_circ(13).values())[0][0]]
            ...
            if outflags1==1:
                syn_flags1 = []
                syn_flags1 += [list(self.run_one_circ(6).values())[0][0]]
                syn_flags1 += [list(self.run_one_circ(8).values())[0][0]]
    ...
    def run_jointQECX_ion(self, error_det, inflags1, inflags2):
        ...
        if error_det:
            ...
            error_det2 = False
            syn2 = []
            out_run2 = list(self.run_one_circ(n_subcirc).values())
            ...
            # the other 2 stabilizer pairs with no flags.
                ...
                if (1 in syn1) and (1 in syn2):
                    ...
                    syn1 += [list(self.run_one_circ(6).values())[0][0]]
                    subcircs_run_QECnonanc[6] = 1
                    syn2 += [list(self.run_one_circ(n_subcirc+6).values())[0][0]]
            ...
            if outflags1==1:
                syn_flags1 = []
                syn_flags1 += [list(self.run_one_circ(9).values())[0][0]]
    ...
    def run_all_gates(self):
        ...
        for q_oper in self.quant_opers:
            ...
            if q_oper.gate_name == 'JointQECZ_flags':
                ...
                meas_dict = output
                meas_outcomes = [val[0] for val in list(meas_dict.values())]
